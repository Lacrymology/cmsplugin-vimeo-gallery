...
def autodiscover_templates():
    '''
    Autodiscovers cmsplugin_vimeo_gallery templates the way
    ...
    override_dir = getattr(settings, 'CMSPLUGIN_VIMEO_GALLERY_TEMPLATES', None)
    if override_dir:
    ...
    for dir in dirs_to_scan:
        found = glob.glob(
            os.path.join(dir, 'cmsplugin_vimeo_gallery/*.html'))
        for file in found:
